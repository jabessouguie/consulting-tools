# 🎨 Fix Couleurs PDF - Consulting Tools

## 🐛 Problème

Les couleurs de la palette Consulting Tools (Rose Poudré, Corail, Terracotta) sont perdues lors de l'export PDF.
...
**Features** :
- ✅ Titres avec couleurs Consulting Tools
...
```bash
# 1. Générer slides avec palette Consulting Tools
...
- [ ] Couleurs palette Consulting Tools visibles
