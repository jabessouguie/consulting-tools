# 🚀 Agents Consulting Tools

Agents d'Intelligence Artificielle pour automatiser les tâches de conseil en stratégie data et IA chez Consulting Tools.
...
- Les références et projets Consulting Tools (NotebookLM + fichiers PPTX)
- Un template PowerPoint professionnel (Consulting Tools_Template_Palette 2026)
- CVs adaptés depuis Biographies - CV All Consulting Tools.pptx
...
- `proposition_client_xyz.pptx`: 📊 **PowerPoint professionnel** avec:
  - Slides structurées selon le template Consulting Tools
  - Diagrammes automatiques (flow, cycle, pyramid, timeline, matrix)
  - CVs adaptés au contexte de l'appel d'offre
  - Tableaux (planning, budget)
  - Palette de couleurs Consulting Tools (terracotta, anthracite, rose poudré)
...
Ce projet est développé pour Consulting Tools. Pour toute suggestion:
...
Propriétaire - Consulting Tools © 2026
...
Développé avec ❤️ par Consulting Tools
