...
Placez le fichier PowerPoint `Biographies - CV All WEnvision.pptx` à la racine du projet.
...
- Contacter l'équipe support WEnvision
- Consulter la documentation dans le dossier `docs/`

## Licence et droits

Propriété de WEnvision - Tous droits réservés

---

**Développé par WEnvision** - Conseil en stratégie data et intelligence artificielle
