...
Suite d'outils d'Intelligence Artificielle pour automatiser la création de contenus et présentations professionnelles chez Consulting Tools.
...
- 📚 **Références** : Intégration NotebookLM et CVs Consulting Tools
- 🎨 **Design** : Palette Consulting Tools (White/Rose Poudré, Noir/Gris, Corail/Terracotta)
...
├── data/                       # 📊 Données
│   ├── notebooklm/            # Références Consulting Tools
...
**2. Ajouter CVs** :
- Placer `Biographies - CV All Consulting Tools.pptx` à la racine
...
Développé pour **Consulting Tools** - Stratégie Data & IA
...
- 📧 **Email** : [Support Consulting Tools]
