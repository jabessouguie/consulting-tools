...
class TestParseConsultantSlide:
    ...
    def test_parse_skip_non_cv(self, agent):
        ...
        result = agent.parse_consultant_slide(
            "This is a cover slide with Consulting Tools logo " "and company presentation text"
        )
            ...
            "slides": [
                {
                    ...
                    "content": [
                        "Alice Durand",
                        "Consultante Senior Data & IA chez Consulting Tools",
                    ],
                },
                {
                    "slide_number": 2,
                    ...
                    "content": [
                        "Bob Martin",
                        "Manager Consulting Data & Strategy chez Consulting Tools",
                    ],
                },
            ],
        }
            ...
            "slides": [
                {
                    "slide_number": 1,
                    "layout": "Cover",
                    "content": ["Consulting Tools Presentation"],
                },
                {
                    "slide_number": 2,
                    "layout": "CV",
...
class TestImportFromText:
    ...
    def test_import_multiple_consultants(self, agent):
        ...
        result = agent.import_from_text(
            "Pierre Leroy - Consultant Junior chez Consulting Tools "
    ...
    def test_import_progress_callback(self, agent):
        ...
        agent.import_from_text(
            ...
            "Java et expertise retail chez Consulting Tools consulting",
