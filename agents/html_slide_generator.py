...
class HtmlSlideGeneratorAgent:
    ...
    def __init__(self, model="gemini-1.5-pro", provider="gemini"):
...
=== IDENTITE VISUELLE Consulting Tools (reference absolue) ===
...
8. Slide "Pourquoi Consulting Tools" (3 stats impactantes avec barres de progression)
...
Chaque slide doit demontrer la valeur ajoutee de Consulting Tools avec des visuels percutants.
{visual_rules}"""
