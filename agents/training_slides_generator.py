...
exportables en Google Slides, respectant la charte graphique Wenvision.
"""
...
{{
    ...
    def generate_slides_for_module(
        ...
        system_prompt = """Tu es un designer de supports de formation chez Wenvision, expert en pédagogie visuelle.
    ...
    def generate_all_slides(self, programme_md: str) -> Dict[str, Any]:
        ...
        closing = {
            ...
            "bullets": [
                "Questions & échanges",
                "Prochaines étapes",
                f"Contact : {os.getenv('CONSULTANT_NAME', 'Wenvision')}",
            ],
        }
...
Tu es un directeur artistique expert chez Wenvision. Ton rôle est de concevoir le prompt visuel pour une infographie pédagogique qui sera générée par Nano Banana Pro.
...
Assure-toi que l'infographie respecte le style de la formation Wenvision, en étant :
...
"""
    ...
    def _wrap_in_full_document(self, title: str, slides_html: List[str]) -> str:
        """Enveloppe les slides dans un document HTML complet avec CSS Wenvision"""
        all_slides = "\n".join(slides_html)
        return f"""
<!DOCTYPE html>
<html lang="fr">
...
"""
    ...
    def generate_module_pptx(self, slides: List[Dict], module_name: str) -> str:
        ...
        template_path = self.base_dir / "WENVISION_Template_Palette 2026.pptx"
        ...
        build_proposal_pptx(
            ...
            consultant_info={
                "name": os.getenv("CONSULTANT_NAME", "Wenvision"),
