...
class ProposalGeneratorAgent:
    ...
    def __init__(self):
        ...
        # Chemins locaux
        self.template_path = os.path.join(BASE_DIR, "Consulting Tools_Template_Palette 2026.pptx")
        ...
        self.biographies_path = os.path.join(BASE_DIR, "Biographies - CV All Consulting Tools.pptx")
...
Et de ces CVs de l'equipe Consulting Tools:
{cvs_text}
...
REFERENCES Consulting Tools:{refs_summary}
...
RÉFÉRENCES Consulting Tools PERTINENTES:
{references.get('selected_references')}

STRUCTURE DU TEMPLATE Consulting Tools:
{template_structure}

La proposition DOIT suivre la structure du template Consulting Tools 2026:
...
2. NOTRE EXPERTISE ET DÉMARCHE À VOTRE SERVICE
   ...
   - Expertise de l'équipe Consulting Tools
...
Sois concret, spécifique au client et à ses enjeux."""
    ...
    def generate_proposal(
        ...
        """
        print(f"\n{'=' * 60}")
        print("GÉNÉRATION DE PROPOSITION COMMERCIALE - Consulting Tools")
        print(f"{'=' * 60}\n")
