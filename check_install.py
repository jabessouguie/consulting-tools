...
def check_dependencies():
    ...
    required = ["fastapi", "uvicorn", "anthropic", "python-dotenv", "pptx", "docx", "PyPDF2"]
...
def check_env_file():
    ...
    if not consultant_name or consultant_name in [
        "Votre Nom Complet",
        "CONFIGURE_CONSULTANT_NAME",
    ]:
    ...
    if not password or password == "CHANGE_ME_ON_FIRST_INSTALL":  # pragma: allowlist secret
