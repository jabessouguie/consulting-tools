...
Ce guide vous explique comment configurer l'accès aux API Google pour utiliser les agents Wenvision.
...
4. Nommez votre projet (ex: "Wenvision-Agents")
5. Cliquez sur "Créer"
...
3. Remplissez les informations:
   - Nom de l'application: "Wenvision Agents"
...
```bash
# Depuis le dossier wenvision-agents
