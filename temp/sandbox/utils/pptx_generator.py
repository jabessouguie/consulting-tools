"""
Generateur de presentations PPTX Wenvision
Utilise le template Wenvision 2026 pour creer des propositions commerciales esthetiques
"""
import os
import copy
...
class ProposalPPTXGenerator:
    """Generateur de PPTX pour propositions commerciales Wenvision"""

    def __init__(self, template_path: str):
        """
        Initialise le generateur avec le template Wenvision
        ...
        # Supprimer les slides existantes du template (on garde juste les layouts)
        while len(self.prs.slides) > 0:
            rId = self.prs.slides._sldIdLst[0].rId
            self.prs.part.drop_rel(rId)
            self.prs.slides._sldIdLst.remove(self.prs.slides._sldIdLst[0])

    def _set_text_style(self, run, font_name=FONT_BODY, size=Pt(14),
    ...
    def _add_paragraph(self, text_frame, text, font_name=FONT_BODY,
                       size=Pt(14), color=None, bold=False,
    ...
    def add_cover_slide(self, client_name: str, project_title: str,
                        date: str, consultant_name: str):
    ...
    def add_content_slide(self, title: str, bullet_points: List[str],
                          subtitle: str = ""):
    ...
    def add_two_column_slide(self, title: str, left_title: str,
                             left_points: List[str], right_title: str,
    ...
    def add_cv_slide(self, name: str, title: str, experiences: List[str],
                     skills: List[str]):
        ...
        bar = slide.shapes.add_shape(
            MSO_SHAPE.RECTANGLE,
            Inches(0.8), Inches(1.5), Inches(11.5), Inches(0.6)
        )
        bar.fill.solid()
        ...
        exp_box = slide.shapes.add_textbox(
            Inches(0.8), Inches(2.3), Inches(6.5), Inches(4.5)
        )
        ...
        skills_box = slide.shapes.add_textbox(
            Inches(7.8), Inches(2.3), Inches(4.5), Inches(4.5)
        )
    ...
    def add_image_slide(self, title: str, image_path: str,
                        caption: str = "", bullets: List[str] = None):
        ...
        text_box = slide.shapes.add_textbox(
            Inches(7.8), Inches(1.8), Inches(4.5), Inches(4.8)
        )
    ...
    def add_diagram_slide(self, title: str, diagram_type: str,
        ...
        if diagram_type == 'flow':
            ...
            for i, element in enumerate(elements):
                ...
                shape = slide.shapes.add_shape(
                    ...
                    left, y_pos, box_width, Inches(1.0)
                )
                shape.fill.solid()
                ...
                if i < num_elements - 1:
                    arrow = slide.shapes.add_shape(
                        ...
                        left + box_width, y_pos + Inches(0.35),
            ...
            timeline_line = slide.shapes.add_shape(
                MSO_SHAPE.ROUNDED_RECTANGLE,
                start_x, y_pos - Inches(0.025), total_width, Inches(0.1)
            )
            ...
            for i, element in enumerate(elements):
                ...
                circle = slide.shapes.add_shape(
                    MSO_SHAPE.OVAL,
                    x_pos - Inches(0.22), y_pos - Inches(0.22),
                ...
                label_shape = slide.shapes.add_shape(
                    MSO_SHAPE.ROUNDED_RECTANGLE,
                    x_pos - Inches(0.9), label_y, Inches(1.8), Inches(0.65)
                )
            ...
            for i, element in enumerate(elements[:matrix_size]):
                ...
                cell = slide.shapes.add_shape(
                    MSO_SHAPE.ROUNDED_RECTANGLE,
                    x, y, cell_width - Inches(0.2), cell_height - Inches(0.2)
                )
                cell.fill.solid()
                # Couleur alternee
                if (row + col) % 2 == 0:
            ...
            # Diagramme circulaire - VERSION AMÉLIORÉE (vrai cycle avec flèches)
            import math
            num_elements = len(elements)
            ...
            for i, element in enumerate(elements):
                # Angle pour positionner en cercle (commencer en haut, sens horaire)
                ...
                shape = slide.shapes.add_shape(
                    MSO_SHAPE.ROUNDED_RECTANGLE,
                    x, y, Inches(2.0), Inches(0.9)
                )
                shape.fill.solid()
                # Couleur dégradée selon la position
                colors = [COLORS['corail'], COLORS['terracotta'], COLORS['rose_poudre'], COLORS['corail']]
            ...
            for i in range(num_elements):
                ...
                arrow = slide.shapes.add_shape(
                    MSO_SHAPE.RIGHT_ARROW,
                    arrow_x, arrow_y, Inches(0.4), Inches(0.25)
                )
                arrow.fill.solid()
                arrow.fill.fore_color.rgb = COLORS['anthracite']
                arrow.line.fill.background()
            ...
            for i, element in enumerate(elements):
                shape = slide.shapes.add_shape(
                    MSO_SHAPE.ROUNDED_RECTANGLE,
                    Inches(2.0), y + i * Inches(0.9), Inches(8.0), Inches(0.7)
                )
                shape.fill.solid()
        ...
        if description:
            desc_box = slide.shapes.add_textbox(
                Inches(1.0), Inches(6.3), Inches(10.0), Inches(0.8)
            )
    ...
    def add_stat_slide(self, stat_value: str, stat_label: str,
                       context: str = "", subtitle: str = ""):
        """
        ...
        stat_box = slide.shapes.add_textbox(
            Inches(1.5), Inches(2.0), Inches(10.0), Inches(2.5)
        )
        ...
        label_box = slide.shapes.add_textbox(
            Inches(1.5), Inches(4.5), Inches(10.0), Inches(0.8)
        )
    ...
    def add_quote_slide(self, quote_text: str, author: str = "",
                        title: str = ""):
        """
        ...
        quote_box = slide.shapes.add_textbox(
            Inches(2.5), y_offset, Inches(8.0), Inches(3.0)
        )
    ...
    def add_highlight_slide(self, title: str, key_points: List[str],
                           highlight_color: str = "corail"):
        """
        ...
        for i, point in enumerate(key_points[:4]):
            ...
            text_tf = slide.shapes.add_textbox(
                x + Inches(0.4), y + Inches(1.0),
                box_width - Inches(0.8), box_height - Inches(1.2)
            )
    ...
    def add_closing_slide(self, consultant_name: str, company: str,
                          contact_info: str = ""):
...
def build_proposal_pptx(
    ...
    Args:
        template_path: Chemin vers le template Wenvision
