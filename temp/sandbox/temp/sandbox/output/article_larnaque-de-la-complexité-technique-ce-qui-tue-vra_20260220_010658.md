...
Le plus dur n'est pas de répondre aux questions techniques, c'est de formaliser les bonnes questions business. Voici la méthode que nous utilisons chez Wenvision pour "hacker" la phase de conception et garantir la scalabilité :
